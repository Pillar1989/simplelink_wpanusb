...
const RFCC26XX_HWAttrsV2 RFCC26XX_hwAttrs = {
    ...
    .globalEventMask    = RF_GlobalEventCmdStart | RF_GlobalEventCmdStop | RF_GlobalEventCoexControl
};
